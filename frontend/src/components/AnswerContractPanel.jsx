...
import { AlertTriangle, ChevronDown, ChevronUp, FileText, GitBranch, GitCompare, HelpCircle, Layers, Quote, ShieldCheck, Sparkles, XCircle } from 'lucide-react';
...
export default function AnswerContractPanel({ data, onFocusGraph }) {
